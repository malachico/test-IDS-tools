...
def banner():
    ...
    print "  https://github.com/m57/reflective_ddos.git"
    print "_" * 37 + "\n"
...
if __name__ == "__main__":
    ...
    x = "y"  # raw_input(c_r + "[!] " + c_e + " This is about to perform a reflected DDoS attack with the above settings.\nAre you sure ? [Y/N] ")
    ...
    while True:
        ...
        try:
            ...
            print c_g + "[*] " + c_e + "All Akamai hosts done!"
            sys.exit(0)
